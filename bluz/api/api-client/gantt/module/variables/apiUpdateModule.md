...
[TypeDoc API](../../../../index.md) / [api-client/gantt/module](../index.md) / apiUpdateModule

# Variable: apiUpdateModule

> **apiUpdateModule**: (`updates`, `options?`) => `Promise`\<`object` & [`BaseGantItem`](../../../../api-shared/types/gantt/models/shared/type-aliases/BaseGantItem.md) & [`BaseDocument`](../../base/type-aliases/BaseDocument.md)\>
...
`Partial`\<[`GanttModule`](../../../../api-shared/types/gantt/models/module/type-aliases/GanttModule.md)\> & `object`
